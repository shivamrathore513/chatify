  ...
  const handleUploadPicture = async (e) => {
    ...
    if (
      ...
      try {
        ...
        data.append("upload_preset", "LifeLine"); // Upload preset in Cloudinary
        data.append("cloud_name", "dwj6op8zr"); // Cloud name in Cloudinary

        const response = await fetch(
          "https://api.cloudinary.com/v1_1/dwj6op8zr/image/upload",
          {
            method: "POST",
            body: data,
          }
